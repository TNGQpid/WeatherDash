...
# Fetch interval in seconds (default 5 minutes)
...
def get_latest_image_urls(sector):
    """Scrape NOAA folder and return sorted latest image URLs (1000x1000 resolution)."""
    ...
    try:
        ...
        for a in soup.find_all("a"):
            href = a.get("href")
            if href and href.endswith("1000x1000.jpg"):
                full_url = url + href
                urls.append(full_url)
            elif href and href.endswith("1200x1200.jpg"):
                full_url = url + href
                urls.append(full_url)
